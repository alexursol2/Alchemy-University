...
contract Voting {
    ...
    function newProposal(address _target, bytes calldata _data) external { // opportunity to change the vote
    ...
    function castVote(uint _proposalId, bool _supports) external {
        // castVote function to allow voters to change their vote on a particular proposal
